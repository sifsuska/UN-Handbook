...
$$
  \mathbf{y_i} = \begin{pmatrix}y_{i1}\\ y_{ik} \\ .. \\y_{iK} \end{pmatrix}
$${#eq-survey}
...
The design-based estimator (where $n$ ias the sample size)
$$
  \boldsymbol{\hat{\beta}_n} = \begin{pmatrix} \boldsymbol{\hat{\beta}}_{n1} \\ .. \\ \boldsymbol{\hat{\beta}}_{nk} \\ .. \\ \boldsymbol{\hat{\beta}}_{nK-1} \end{pmatrix}
$${#eq-design}
is design-consistent for the maximum likelihood estimator of $\boldsymbol{\beta}$, expressed as
$$
  \boldsymbol{\beta} = \begin{pmatrix}\beta_{1}\\ .. \\ \beta_{k} \\ .. \\ \beta_{K-1} \end{pmatrix}
$${#eq-mlest}
...
and
$$
  \mathbf{\hat{G}}_{Rk} = \Bigl[ \mathbf{r}_{kN_R}\enspace N_{N_Rp1} \enspace  N_{N_Rp2} \enspace  ... \enspace N_{N_RpK} \Bigr].
$${#eq-grk}
