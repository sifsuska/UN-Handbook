...
determination (R²) exceeding 0.99, as shown in @fig-4-uav-wheat.
...
#| out-width: 90%
#| fig-cap: |
#|  Comparison of UHD185 and resampling ASD spectral curves.
#| fig-align: center
...
```{r}
#| echo: FALSE
#| label: fig-4-uav-wheat
#| out-width: 70%
#| fig-cap: |
#|  Correlation between UHD185 and resampling ASD spectral reflectance.
#| fig-align: center
...
@fig-6-uav-wheat and @fig-7-uav-wheat show the variable selection process 
using the SPA
...
#| out-width: 75%
#| fig-cap: |
#|  SPA variable filtering process: (a) number of model variables.
#| fig-align: center
...
```{r}
#| echo: FALSE
#| label: fig-7-uav-wheat
#| out-width: 75%
#| fig-cap: |
#|  SPA variable filtering process: (b) variable indexes.
#| fig-align: center
...
Xingming Ma is a researcher at the College of Agronomy, Henan Agricultural University, Zhengzhou, China. 
