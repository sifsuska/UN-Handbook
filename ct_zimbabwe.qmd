...
author: "Lorenzo De Simone, Sophie Bontemps, Nelson Mpfugami, Phibion Chiwara"
format: html
---
...
To calibrate and validate the classification, a comprehensive set of
ground observations was collected. The core of this dataset consisted of
approximately 2,910 windshield survey points, systematically collected
across the country. To strengthen spatial and spectral
representativeness, these points were further augmented with 1,410
polygons delineated by expert photointerpretation of Sentinel-2 and very
...
@fig-1-zimbabwe. This dataset provided the statistical foundation for training the Random Forest model and for assessing the quality of the national crop type map.
...
#| fig-align: center
knitr::include_graphics("./images/ct_zimbabwe/image_1.png")
```
...
through machine learning techniques. For this case study, a Random
...
The model was trained on a set of input features derived from Sentinel-2
...
was applied during training. This procedure generates artificial samples
...
@fig-2-zimbabwe. The map provides a spatially explicit representation of Zimbabwe's agricultural landscape, highlighting the dominance 
of particular crops
...
#| fig-align: center
knitr::include_graphics("./images/ct_zimbabwe/image_2.png")
```
...
F-score chart (@fig-3-zimbabwe) and the confusion matrix 
(@fig-4-zimbabwe).

```{r}
#| echo: FALSE
#| label: fig-3-zimbabwe
#| out-width: 90%
#| fig-cap: |
#|   Class-specific F-scores of the national summer crop type map.
#| fig-align: center
knitr::include_graphics("./images/ct_zimbabwe/image_3.png")
```
...
#| fig-align: center
knitr::include_graphics("./images/ct_zimbabwe/image_4.png")
```
...
classifications with more than five crop classes [Defourny2022]. 
