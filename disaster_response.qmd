...
food system resilience amid increasing global uncertainties [@Wang2022] 
[@Jaber2022] [@Neog2024].
...
prioritize interventions with greater efficiency and accuracy [@Hu2023].
...
malnutrition [@Farooq2023] [@UNDP2021].
...
without significant intervention [@Conforti2018].
...
[@OECD2021]. Within the agricultural domain, disasters often 
...
trajectory of recovery and resilience-building [@OECD2021].
...
agricultural systems [@Kumari2025]. This chapter provides 
...
disaster evaluations [@VanWesten2000]. Optical sensors, 
...
remote sensing sensors in agricultural disaster response [@Colpaert2022] [@Panda2024]. 
The common
...
Vegetation Index - NDVI [@Pettorelli2013]
and Enhanced Vegetation Index - EVI [@Jiang2008] are widely
...
Difference Water Index (NDWI) [@Gao1996]
...
[Wang2022] [@Jaber2022] [@Neog2024] [@Hu2023].
...
ground surveys to ensure accuracy [@Vu-Duc2025].
...
aperture radar (SAR) [@Panda2024] and multispectral imaging, 
...
high-resolution insights [@Victor2024].
...
and system calibration to maintain accuracy and reliability [@Clemens-Meyer2021]. Robust
...
detection and vegetation index analysis [@Wankhede2023]. 
