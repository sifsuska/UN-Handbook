...
Anchored by: Luis Ambrosio, UPM/Spain

When survey data are collected through a list frame---that is, one
labeled centroid per parcel without direct measurement of parcel
areas---linear regression estimators designed for continuous variables
