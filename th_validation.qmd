...
reproducible-local:
    enabled: true
    repository-url: "https://github.com/FAO-EOSTAT/un-handbook-th-validation"
---
...
#| fig-align: center
knitr::include_graphics("./images/th_validation/valromosaic.png") 
```
...
area_acc_val_map <- readRDS("./etc/area_acc_val_map.rds")
area_acc_val_map
```
