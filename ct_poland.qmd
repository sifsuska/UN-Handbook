...
Artur Łączyński, consultant in Department of Agriculture and Environment in Statistics Poland, former director of Agriculture Department (2010-2023), leader and expert concerning agriculture, statistics, modern methods of data collection, methodology of surveys, and particularly use of satellite data in agricultural statistics. Within years 2018-2025, he was responsible for establishing in Poland the system for satellite identification and monitoring of crops for the purposes of agricultural statistics, which permanently delivers essential information on area and yielding. Artur Łączyński was the international expert of European Commission, FAO, ILO, World Bank in several countries such as Azerbaijan, Croatia, Israel, Jordan, Kazakhstan, Moldova, in domain of agricultural statistics. He represents Statistics Poland in UN-CEBD/UN-CEAG Task team on the use of EO data.
...
Przemysław Slesiński is a geodesy and remote-sensing specialist with a Master’s in Geodesy and Satellite Navigation. Since 2011 he has been Chief Specialist at the Statistical Office in Olsztyn, developing spatial databases, performing network analyses, and processing satellite data for agricultural statistics. He also serves as IT technician and UAV operator at the University of Warmia and Mazury. Skills: GIS (ArcGIS, QGIS, SNAP), object-based classification, SAR processing and machine learning; co-author of multiple EO publications.
